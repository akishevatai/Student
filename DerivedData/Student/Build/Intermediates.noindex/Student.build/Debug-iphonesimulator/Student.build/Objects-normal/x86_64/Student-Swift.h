...
#ifndef STUDENT_SWIFT_H
#define STUDENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Student",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Student24AddStudentViewController")
...
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified saveBarButtonItem;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified avatarImage;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified addAvatarButton;
- (void)viewDidLoad;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)editingDidChanged:(UITextField * _Nonnull)sender;
- (IBAction)saveButton;
...
SWIFT_CLASS("_TtC7Student11AppDelegate")
...
SWIFT_CLASS("_TtC7Student26AvatarPickerViewController")
@interface AvatarPickerViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7Student13SceneDelegate")
...
SWIFT_CLASS("_TtC7Student7Student")
...
SWIFT_CLASS("_TtC7Student26StudentTableViewController")
